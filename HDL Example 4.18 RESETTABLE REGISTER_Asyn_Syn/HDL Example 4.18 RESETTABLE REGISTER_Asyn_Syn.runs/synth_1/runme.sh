...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.18 RESETTABLE REGISTER_Asyn_Syn/HDL Example 4.18 RESETTABLE REGISTER_Asyn_Syn.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flopr_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flopr_top.tcl
