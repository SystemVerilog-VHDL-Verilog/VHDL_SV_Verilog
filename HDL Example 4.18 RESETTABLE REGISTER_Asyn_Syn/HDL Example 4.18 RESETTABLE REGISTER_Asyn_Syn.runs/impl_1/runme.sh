...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.18 RESETTABLE REGISTER_Asyn_Syn/HDL Example 4.18 RESETTABLE REGISTER_Asyn_Syn.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flopr_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flopr_top.tcl -notrace
