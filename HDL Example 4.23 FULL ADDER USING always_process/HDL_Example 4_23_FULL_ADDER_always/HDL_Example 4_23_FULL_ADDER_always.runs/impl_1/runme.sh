...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.23 FULL ADDER USING always_process/HDL_Example 4_23_FULL_ADDER_always/HDL_Example 4_23_FULL_ADDER_always.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fulladder_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fulladder_top.tcl -notrace
