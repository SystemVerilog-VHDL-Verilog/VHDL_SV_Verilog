...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.23 FULL ADDER USING always_process/HDL_Example 4_23_FULL_ADDER_always/HDL_Example 4_23_FULL_ADDER_always.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fulladder_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fulladder_top.tcl
