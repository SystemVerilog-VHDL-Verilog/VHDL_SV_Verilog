...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.31 PATTERN RECOGNIZER MOORE FSM/HDL Example 4_31 PATTERN RECOGNIZER MOORE FSM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log patternMoore_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source patternMoore_top.tcl
