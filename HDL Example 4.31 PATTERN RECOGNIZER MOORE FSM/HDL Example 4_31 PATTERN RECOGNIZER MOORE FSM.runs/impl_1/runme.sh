...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.31 PATTERN RECOGNIZER MOORE FSM/HDL Example 4_31 PATTERN RECOGNIZER MOORE FSM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log patternMoore_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source patternMoore_top.tcl -notrace
