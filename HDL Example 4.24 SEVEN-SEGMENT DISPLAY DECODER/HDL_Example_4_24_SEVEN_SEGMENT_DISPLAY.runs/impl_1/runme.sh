...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.24 SEVEN-SEGMENT DISPLAY DECODER/HDL_Example_4_24_SEVEN_SEGMENT_DISPLAY.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sevenseg_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sevenseg_top.tcl -notrace
