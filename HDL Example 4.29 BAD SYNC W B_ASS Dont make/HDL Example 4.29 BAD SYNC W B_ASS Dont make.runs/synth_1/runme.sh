...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.29 BAD SYNC W B_ASS Dont make/HDL Example 4.29 BAD SYNC W B_ASS Dont make.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log syncbad_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source syncbad_top.tcl
