...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.29 BAD SYNC W B_ASS Dont make/HDL Example 4.29 BAD SYNC W B_ASS Dont make.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log syncbad_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source syncbad_top.tcl -notrace
