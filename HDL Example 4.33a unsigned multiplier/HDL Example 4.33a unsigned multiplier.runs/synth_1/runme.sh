...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.33a unsigned multiplier/HDL Example 4.33a unsigned multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiplier_top.tcl
