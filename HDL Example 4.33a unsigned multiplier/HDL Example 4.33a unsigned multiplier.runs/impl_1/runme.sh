...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.33a unsigned multiplier/HDL Example 4.33a unsigned multiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiplier_top.tcl -notrace
