...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.30 DIVIDE-BY-3 FINITE STATE MACHINE/HDL Example 4.30 DIVIDE-BY-3 FINITE STATE MACHINE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log divideby3FSM_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source divideby3FSM_top.tcl
