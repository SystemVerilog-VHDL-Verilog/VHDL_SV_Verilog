...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.30 DIVIDE-BY-3 FINITE STATE MACHINE/HDL Example 4.30 DIVIDE-BY-3 FINITE STATE MACHINE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log divideby3FSM_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source divideby3FSM_top.tcl -notrace
