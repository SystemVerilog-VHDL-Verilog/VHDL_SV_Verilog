...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.10 TRISTATE BUFFER/HDL Example 4.10 TRISTATE BUFFER.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tristate_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tristate_top.tcl
