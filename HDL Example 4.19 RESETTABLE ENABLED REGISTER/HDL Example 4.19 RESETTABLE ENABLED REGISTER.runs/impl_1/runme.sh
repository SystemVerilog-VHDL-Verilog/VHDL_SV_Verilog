...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.19 RESETTABLE ENABLED REGISTER/HDL Example 4.19 RESETTABLE ENABLED REGISTER.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flopenr_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flopenr_top.tcl -notrace
