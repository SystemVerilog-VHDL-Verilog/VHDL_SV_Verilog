...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.19 RESETTABLE ENABLED REGISTER/HDL Example 4.19 RESETTABLE ENABLED REGISTER.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flopenr_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flopenr_top.tcl
