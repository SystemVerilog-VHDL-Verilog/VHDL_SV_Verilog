...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.34b PARAMETERIZED N-BIT MULTIPLEXERS/HDL Example 4.34b PARAM N-BIT MULT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux4_12_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux4_12_top.tcl
