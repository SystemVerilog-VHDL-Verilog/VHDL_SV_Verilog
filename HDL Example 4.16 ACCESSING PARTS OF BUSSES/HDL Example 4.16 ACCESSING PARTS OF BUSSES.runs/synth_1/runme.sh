...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.16 ACCESSING PARTS OF BUSSES/HDL Example 4.16 ACCESSING PARTS OF BUSSES.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux2_8_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux2_8_top.tcl
