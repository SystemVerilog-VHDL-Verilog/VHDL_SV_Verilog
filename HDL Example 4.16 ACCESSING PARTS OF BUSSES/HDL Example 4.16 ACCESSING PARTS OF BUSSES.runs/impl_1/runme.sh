...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.16 ACCESSING PARTS OF BUSSES/HDL Example 4.16 ACCESSING PARTS OF BUSSES.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux2_8_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux2_8_top.tcl -notrace
