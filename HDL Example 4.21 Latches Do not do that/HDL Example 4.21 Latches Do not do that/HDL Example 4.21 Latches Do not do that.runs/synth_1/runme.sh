...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.21 Latches Do not do that/HDL Example 4.21 Latches Do not do that/HDL Example 4.21 Latches Do not do that.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Latch_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Latch_top.tcl
