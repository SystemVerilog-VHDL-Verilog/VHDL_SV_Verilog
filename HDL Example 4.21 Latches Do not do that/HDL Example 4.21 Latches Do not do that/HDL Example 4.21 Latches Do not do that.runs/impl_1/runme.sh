...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.21 Latches Do not do that/HDL Example 4.21 Latches Do not do that/HDL Example 4.21 Latches Do not do that.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Latch_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Latch_top.tcl -notrace
