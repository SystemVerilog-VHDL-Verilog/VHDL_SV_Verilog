...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.20 SYNCHRONIZER/HDL Example 4.20 SYNCHRONIZER/HDL Example 4.20 SYNCHRONIZER.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sync_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sync_top.tcl
