...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.20 SYNCHRONIZER/HDL Example 4.20 SYNCHRONIZER/HDL Example 4.20 SYNCHRONIZER.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sync_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sync_top.tcl -notrace
