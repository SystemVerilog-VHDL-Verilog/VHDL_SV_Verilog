...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.12 BIT SWIZZLING/HDL Example 4.12 BIT SWIZZLING.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BIT_SWIZZLING_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BIT_SWIZZLING_top.tcl
