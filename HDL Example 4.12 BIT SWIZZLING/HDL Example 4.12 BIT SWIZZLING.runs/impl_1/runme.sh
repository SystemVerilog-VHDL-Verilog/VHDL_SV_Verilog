...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.12 BIT SWIZZLING/HDL Example 4.12 BIT SWIZZLING.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BIT_SWIZZLING_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BIT_SWIZZLING_top.tcl -notrace
