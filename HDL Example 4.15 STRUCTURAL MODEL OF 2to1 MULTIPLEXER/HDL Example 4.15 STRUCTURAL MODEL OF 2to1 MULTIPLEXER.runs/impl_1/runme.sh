...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.15 STRUCTURAL MODEL OF 2to1 MULTIPLEXER/HDL Example 4.15 STRUCTURAL MODEL OF 2to1 MULTIPLEXER.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux2_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux2_top.tcl -notrace
