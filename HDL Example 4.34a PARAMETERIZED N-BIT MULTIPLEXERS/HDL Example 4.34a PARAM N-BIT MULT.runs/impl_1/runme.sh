...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.34a PARAMETERIZED N-BIT MULTIPLEXERS/HDL Example 4.34a PARAM N-BIT MULT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux4_8_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux4_8_top.tcl -notrace
