...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.34a PARAMETERIZED N-BIT MULTIPLEXERS/HDL Example 4.34a PARAM N-BIT MULT.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log mux4_8_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux4_8_top.tcl
