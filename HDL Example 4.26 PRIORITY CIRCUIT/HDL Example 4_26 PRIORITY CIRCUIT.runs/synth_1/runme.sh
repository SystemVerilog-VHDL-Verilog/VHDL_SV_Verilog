...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.26 PRIORITY CIRCUIT/HDL Example 4_26 PRIORITY CIRCUIT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log priority_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source priority_top.tcl
