...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.26 PRIORITY CIRCUIT/HDL Example 4_26 PRIORITY CIRCUIT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log priority_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source priority_top.tcl -notrace
