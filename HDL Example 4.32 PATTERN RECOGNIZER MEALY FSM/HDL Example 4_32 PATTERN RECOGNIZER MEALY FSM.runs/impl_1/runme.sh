...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.32 PATTERN RECOGNIZER MEALY FSM/HDL Example 4_32 PATTERN RECOGNIZER MEALY FSM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log patternMealy_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source patternMealy_top.tcl -notrace
