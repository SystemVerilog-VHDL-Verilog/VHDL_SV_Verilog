...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.32 PATTERN RECOGNIZER MEALY FSM/HDL Example 4_32 PATTERN RECOGNIZER MEALY FSM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log patternMealy_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source patternMealy_top.tcl
