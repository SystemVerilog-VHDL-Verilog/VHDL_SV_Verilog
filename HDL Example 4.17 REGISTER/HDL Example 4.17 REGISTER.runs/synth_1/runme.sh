...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.17 REGISTER/HDL Example 4.17 REGISTER.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flop_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flop_top.tcl
