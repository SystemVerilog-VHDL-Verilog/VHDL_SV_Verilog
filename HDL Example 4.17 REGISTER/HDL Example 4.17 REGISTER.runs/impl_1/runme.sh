...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.17 REGISTER/HDL Example 4.17 REGISTER.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flop_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flop_top.tcl -notrace
