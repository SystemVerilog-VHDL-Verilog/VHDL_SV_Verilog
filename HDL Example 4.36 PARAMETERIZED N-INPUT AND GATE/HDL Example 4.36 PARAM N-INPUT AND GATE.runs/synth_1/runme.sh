...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.36 PARAMETERIZED N-INPUT AND GATE/HDL Example 4.36 PARAM N-INPUT AND GATE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log andN_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source andN_top.tcl
