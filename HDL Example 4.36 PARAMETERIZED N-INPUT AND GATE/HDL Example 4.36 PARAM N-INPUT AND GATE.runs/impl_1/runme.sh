...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.36 PARAMETERIZED N-INPUT AND GATE/HDL Example 4.36 PARAM N-INPUT AND GATE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log andN_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source andN_top.tcl -notrace
