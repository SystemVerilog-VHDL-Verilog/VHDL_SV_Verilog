...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.28 FULL ADDER USING NONBLOCKING ASSIGNMENTS not recommended/HDL Example 4.28 FULL ADDER NB.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fulladder_nb_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fulladder_nb_top.tcl
