...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.22 INVERTER USING always_process/HDL_Example_4_22_INVERTER_always/HDL_Example_4_22_INVERTER_always.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log inv_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source inv_top.tcl -notrace
