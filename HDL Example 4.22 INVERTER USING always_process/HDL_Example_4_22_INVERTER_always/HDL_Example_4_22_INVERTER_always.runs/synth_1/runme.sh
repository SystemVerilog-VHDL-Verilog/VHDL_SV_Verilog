...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.22 INVERTER USING always_process/HDL_Example_4_22_INVERTER_always/HDL_Example_4_22_INVERTER_always.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log inv_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source inv_top.tcl
