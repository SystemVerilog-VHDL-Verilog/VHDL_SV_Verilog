...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.1 COMBINATIONAL LOGIC/HDL Example 4.1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sillyfunction_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sillyfunction_top.tcl -notrace
