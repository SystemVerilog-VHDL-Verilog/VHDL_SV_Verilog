...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.1 COMBINATIONAL LOGIC/HDL Example 4.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sillyfunction_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sillyfunction_top.tcl
