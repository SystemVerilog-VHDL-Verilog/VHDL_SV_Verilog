...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.35 PARAMETERIZED Nto2N DECODER/HDL Example 4.35 PARAM Nto2N DECODER.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder_top.tcl
