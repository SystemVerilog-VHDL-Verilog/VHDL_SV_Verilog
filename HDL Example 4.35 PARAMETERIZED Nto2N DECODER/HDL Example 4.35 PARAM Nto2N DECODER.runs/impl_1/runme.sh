...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.35 PARAMETERIZED Nto2N DECODER/HDL Example 4.35 PARAM Nto2N DECODER.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decoder_top.tcl -notrace
