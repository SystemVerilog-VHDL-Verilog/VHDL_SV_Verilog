...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.4 EIGHT-INPUT AND/HDL Example 4.4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log and8_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source and8_top.tcl -notrace
