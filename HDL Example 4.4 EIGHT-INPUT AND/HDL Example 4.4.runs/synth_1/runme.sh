...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.4 EIGHT-INPUT AND/HDL Example 4.4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log and8_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source and8_top.tcl
