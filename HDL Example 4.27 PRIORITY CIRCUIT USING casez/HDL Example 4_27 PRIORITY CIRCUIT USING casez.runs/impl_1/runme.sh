...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.27 PRIORITY CIRCUIT USING casez/HDL Example 4_27 PRIORITY CIRCUIT USING casez.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log priority_casez_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source priority_casez_top.tcl -notrace
