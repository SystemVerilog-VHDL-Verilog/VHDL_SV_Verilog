...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.27 PRIORITY CIRCUIT USING casez/HDL Example 4_27 PRIORITY CIRCUIT USING casez.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log priority_casez_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source priority_casez_top.tcl
