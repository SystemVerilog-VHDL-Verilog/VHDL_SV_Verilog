...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.25 3to8 DECODER/HDL Example 4.25 3to8 DECODER.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder3_8_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decoder3_8_top.tcl -notrace
