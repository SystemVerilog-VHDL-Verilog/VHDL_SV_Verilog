...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.25 3to8 DECODER/HDL Example 4.25 3to8 DECODER.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder3_8_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder3_8_top.tcl
