...
HD_PWD='C:/Zynq_Book/VHDL_SV_Verilog/HDL Example 4.14 STRUCTURAL MODEL OF 4to1 MULTIPLEXER/HDL Example 4.14 STRUCTURAL MODEL OF 4to1 MULTIPLEXER.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux4_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux4_top.tcl
